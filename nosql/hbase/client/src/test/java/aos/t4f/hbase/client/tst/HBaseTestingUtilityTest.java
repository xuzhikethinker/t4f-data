...
public class HBaseTestingUtilityTest {
    private static final Logger log = Logger.getLogger(HBaseTestingUtilityTest.class);
    ...
    public void testHBaseCluster() throws Exception {
        ...
        Iterator<Map.Entry<String, String>> it = hbaseTestingUtility.getMiniHBaseCluster().getConfiguration().iterator();
        while (it.hasNext()) {
           Map.Entry<String, String> next = it.next();
           System.out.println(next.getKey() + " = " + next.getValue());
        }
//        HTable table = new HTable(hbaseTestingUtility.getConfiguration(), "test");
