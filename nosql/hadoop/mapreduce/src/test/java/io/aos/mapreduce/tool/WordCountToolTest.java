...
import io.aos.mapreduce.tool.WordCountTool.WordCountMapper;
import io.aos.mapreduce.tool.WordCountTool.WordCountReducer;
...
public class WordCountToolTest {
    ...
    private void validateCounters(Counters counters, long mapInputRecords,
        ...
        assertEquals("MapOutputRecords", mapOutputRecords, counters
                .findCounter("MyCounterGroup", "MAP_OUTPUT_RECORDS").getValue());
