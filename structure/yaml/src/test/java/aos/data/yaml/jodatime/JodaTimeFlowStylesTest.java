 ...
 * under the License.                                           *
 ****************************************************************/
package aos.data.yaml.jodatime;
...
public class JodaTimeFlowStylesTest extends TestCase {
    ...
    public void testLoadBeanWithBlockFlow() {
        ...
        try {
            ...
            assertTrue("The error must indicate that JodaTime cannot be created from the scalar value.", e.getMessage()
                    .contains("No String constructor found. Exception=org.joda.time.DateTime.<init>(java.lang.String)"));
        }
