 ...
 * under the License.                                           *
 ****************************************************************/
package io.aos.data.yaml.collections;

import io.aos.data.yaml.Util;
...
public class TypeSafeMapImplementationsTest extends TestCase {
  ...
  public void testRecursiveNoJavaBeanMap1() {
    ...
    Map<Object, Object> map1 =
        (Map<Object, Object>) yaml.load(Util
  ...
  public void testRecursiveNoJavaBeanMap3() {
    ...
    // System.out.println(output);
    @SuppressWarnings("unchecked")
    SortedMap<Object, Object> map1 =
        (SortedMap<Object, Object>) yaml.load(output);
    assertEquals(3, map1.size());
    assertEquals("one", map1.get("1"));
    assertEquals("two", map1.get("2"));
  ...
  public void testRecursiveNoJavaBeanProperties4() {
    ...
    try {
      ...
      assertTrue(e.getMessage(),
          e.getMessage().contains("Properties must not be recursive."));
    }
  }
}
