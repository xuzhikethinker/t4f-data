 ...
 * under the License.                                           *
 ****************************************************************/
package aos.data.aos.map;

import aos.data.aos.iterator.AosIterator;
import aos.data.aos.iterator.IteratorOutOfBoundsException;

/**
 * An iterator over all the values in a {@link Map}.
 *
 */
public class MapValueIterator implements AosIterator {
     ...
     */
    public MapValueIterator(AosIterator entries) {
