 ...
 * under the License.                                           *
 ****************************************************************/
package aos.data.aos.queue;

import aos.data.aos.comparator.Comparator;
import aos.data.aos.comparator.NaturalComparator;
import aos.data.aos.queue.EmptyQueueException;
import aos.data.aos.queue.Queue;
import junit.framework.TestCase;

/**
 * Abstract base class for testing implementations of LIFO {@link aos.data.aos.queue.Queue}s.
 *
 */
