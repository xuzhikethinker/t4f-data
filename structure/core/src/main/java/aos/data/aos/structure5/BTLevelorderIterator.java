 ...
 * Example usage:
 * <pre>
 *      {@link aos.data.aos.structure.BinaryTree BinaryTree} t = new {@link aos.data.aos.structure.BinaryTree#BinaryTree() BinaryTree()};
 *      // ...tree is grown
 *      {@link java.util.Iterator Iterator} ti = t.{@link aos.data.aos.structure.BinaryTree#levelorderIterator() levelorderIterator()};
