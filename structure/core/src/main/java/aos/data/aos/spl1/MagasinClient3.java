 ...
 */
package aos.data.aos.spl1;


// Pour que l'objet soit classable, on doit impl�menter l'interface Comparable
public class MagasinClient3 implements Comparable{
    ...
    public MagasinClient3 (String nom, String prenom) {
    ...
    public boolean equals(Object o) {
        ...
        // -> appel "r�cursif"
        return ((this.nom.equals(((MagasinClient3)o).getLastname())&&(this.prenom.equals(((MagasinClient3)o).getFirstname()))));
    }
    ...
    public int compareTo(Object o) {
        return new Integer(this.achats).compareTo(new Integer(((MagasinClient3)o).getValue()));
    }
}
