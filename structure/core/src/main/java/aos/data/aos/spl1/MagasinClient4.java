...
// Remarque : la classe client n'impl�mente plus l'interface comparable
public class MagasinClient4 {
    ...
    public MagasinClient4 (String nom, String prenom) {
    ...
    public boolean equals(Object o) {
        ...
        // -> appel "r�cursif"
        return ((this.nom.equals(((MagasinClient4)o).getLastname())&&(this.prenom.equals(((MagasinClient4)o).getFirstname()))));
    }
}
