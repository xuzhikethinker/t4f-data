 ...
 * Example usage:
 * <pre>
 *      {@link aos.data.structure.BinaryTree BinaryTree} t = new {@link aos.data.structure.BinaryTree#BinaryTree() BinaryTree()};
 *      // ...tree is grown
 *      {@link java.util.Iterator Iterator} ti = t.{@link aos.data.structure.BinaryTree#levelorderIterator() levelorderIterator()};
