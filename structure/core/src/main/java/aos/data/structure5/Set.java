 ...
 *      Set thesisSet = new {@link aos.data.structure.SetVector#SetVector()}, 
 *          gradSet = new {@link aos.data.structure.SetVector#SetVector()};
 *              
 *      //build sets up
 *      for(int i = 0; i < thesis.length; i++) thesisSet.{@link aos.data.structure.SetVector#add(Object) add(thesis[i])};
 *      for(int i = 0; i < grad.length; i++) gradSet.{@link aos.data.structure.SetVector#add(Object) add(grad[i])};
 *      
 *      //calculate the intersection of the two sets
 *      thesisSet.{@link aos.data.structure.SetVector#retainAll(Structure) retainAll(gradSet)};
