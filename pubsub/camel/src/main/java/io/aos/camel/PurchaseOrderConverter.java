...
public final class PurchaseOrderConverter {
    ...
    @Converter
    public static PurchaseOrderImmutable toPurchaseOrder(byte[] data, Exchange exchange) {
        ...
        PurchaseOrderImmutable order = new PurchaseOrderImmutable(name, price, amount);
        return order;
    }
