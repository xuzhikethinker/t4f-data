 ...
 * 
 * Orders on the xmlOrders queue are also sent out to the production and 
 * accounting queues if the order originated from a gold customer. The
 * recipient list annotation is used to do this.
 *
 * @author janstey
 *
 */
