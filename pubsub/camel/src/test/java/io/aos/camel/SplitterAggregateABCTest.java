 ...
 * Each of those message is then translated into a quote using the {@link io.aos.camel.WordTranslateBean} bean.
 * The Splitter will then aggregate those messages into a single combined outgoing message.
 * This is done using the {@link io.aos.camel.MyAggregationStrategy}.
 *
