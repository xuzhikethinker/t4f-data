...
import io.aos.camel.Inventory;
import io.aos.camel.RiderService;
import io.aos.camel.ShippingDetail;
...
public class StarterKitMockedSedaTest extends CamelSpringTestSupport {
    ...
    private static final Log LOG = LogFactory.getLog(StarterKitMockedSedaTest.class);

    @Override
    protected AbstractXmlApplicationContext createApplicationContext() {
        return new ClassPathXmlApplicationContext("META-INF/spring/camel-mocked-seda.xml");
    }
