...
public class ProducerTemplateDefinedInSpringTest extends CamelSpringTestSupport {
    ...
    @Test
    public void testProducerTemplateDefinedInSpring() throws Exception {
        assertEquals("Processing", template.requestBody("activemq:order.status", "123"));
        assertEquals("Complete", template.requestBody("activemq:order.status", "321")); 
    }
