 ...
 */
public class CamelFutureGetTest extends CamelTestSupport {

    private static Log LOG = LogFactory.getLog(CamelFutureGetTest.class);
    ...
    public void testFutureGet() throws Exception {
        ...
        // and get the answer (it will automatic wait for the task to be complete)
