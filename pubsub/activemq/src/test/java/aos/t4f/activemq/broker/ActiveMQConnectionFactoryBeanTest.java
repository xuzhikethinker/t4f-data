 ...
 */
public class ActiveMQConnectionFactoryBeanTest extends TestCase {
	
    private static final transient Log LOG = LogFactory.getLog(ActiveMQConnectionFactoryBeanTest.class);
