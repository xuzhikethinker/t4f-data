 ...
 * under the License.                                           *
 ****************************************************************/
package aos.t4f.activemq.console;
...
public class ActiveMQConsole {
    ...
    public boolean canUseExtdir() {
        try {
            ActiveMQConsole.class.getClassLoader().loadClass(TASK_DEFAULT_CLASS);
            return false;
        } catch (ClassNotFoundException e) {
            return true;
        }
    ...
    public ClassLoader getClassLoader() throws MalformedURLException {
        if (classLoader == null) {
            ...
            classLoader = ActiveMQConsole.class.getClassLoader();
    ...
    public File getActiveMQHome() {
        if (activeMQHome == null) {
            ...
            if (activeMQHome == null) {
                ...
                URL url = ActiveMQConsole.class.getClassLoader().getResource("org/apache/activemq/console/Main.class");
                if (url != null) {
                    try {
