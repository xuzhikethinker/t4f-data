...
import org.apache.lucene.search.ParallelIndexSearcher;
...
public class SearchServer {
  ...
  public static void main(String[] args) throws Exception {
    ...
    Searcher multiSearcher = new IndexSearcher(searchables); //4
    ...
    Searcher parallelSearcher =                             //5
        new ParallelIndexSearcher(searchables);             //5
...
/*
  ...
  #4 IndexSearcher over all indexes
  #5 ParallelIndexSearcher over all indexes
*/
