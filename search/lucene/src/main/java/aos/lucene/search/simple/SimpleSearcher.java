...
public class SimpleSearcher {
    ...
    public static void main(String[] args) throws IllegalArgumentException, IOException, ParseException {
        ...
        if (args.length != 2) {
            throw new IllegalArgumentException("Usage: java " + SimpleSearcher.class.getName() + " <index dir> <query>");
        }
    ...
    public static void search(String indexDir, String q) throws IOException, ParseException {
        ...
        QueryParser parser = new QueryParser(Version.LUCENE_50, "contents", new StandardAnalyzer(Version.LUCENE_50));
