 ...
 * rid of it when LUCENE-2638 is integrated.</b>
 * 
 * <code>HighFreqTerms</code> class extracts the top n most frequent terms (by
 * document frequency ) from an existing Lucene index and reports their document
...
public class AosFrequencyTerms {
	 ...
	 * @throws Exception
	 */
	public static AosTermStats[] getHighFreqTerms(IndexReader reader, int numTerms, String[] fieldNames) throws Exception {
