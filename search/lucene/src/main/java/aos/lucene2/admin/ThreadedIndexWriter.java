...
/*
 * #A Holds one document to be added #B Does real work to add or update document
 * #C Create thread pool #D Have thread pool execute job #E Shuts down thread
 * pool
 */
