...
public class AOSIndexCreationQueryOptimizeTest {
    ...
    // Query query = new QueryParser(Version.LUCENE_40, "title",
    // analyzer).parse(queryString);
    // query(indexSearcher, query);
    // queryString = "tag4";
    // query = new QueryParser(Version.LUCENE_40, "tag",
    // analyzer).parse(queryString);
    // query(indexSearcher, query);
    //
    // System.out.println("\n==============================");
    //
    // config = new IndexWriterConfig(Version.LUCENE_40, new
    // StandardAnalyzer(Version.LUCENE_40));
    ...
    // query = new QueryParser(Version.LUCENE_40, "title",
    // analyzer).parse(queryString);
    // query(indexSearcher, query);
    // queryString = "tag4";
    // query = new QueryParser(Version.LUCENE_40, "tag",
