...
public class JdbcSpl {
    ...
    private static final String CREATE_SQL = "CREATE TABLE MAPS ("
            ...
            + "PHOTO_FORMAT VARCHAR(26) NOT NULL, " + "UNIQUE (MAP_ID, MAP_NAME) " + ")";

    private static final String INSERT_SQL = "INSERT INTO MAPS " + "(MAP_NAME, REGION, AREA, PHOTO_FORMAT) "
            + "VALUES " + "('MAP1', 'REGION1', 3, 'FORMAT1')";
    ...
    public static void main(String[] args) throws SQLException {
        ...
        System.out.println(stmt.execute(CREATE_SQL));

        stmt = connection.createStatement();
        System.out.println(stmt.execute(INSERT_SQL));

        stmt = connection.createStatement();
        ResultSet rs = stmt.executeQuery(SELECT_SQL);
        while (rs.next()) {
            System.out.printf("map_id= %s - map_name %s - region %s\n", rs.getInt("MAP_ID"), rs.getString("MAP_NAME"),
                    rs.getString("REGION"));
        }
